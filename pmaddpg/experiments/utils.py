...
from experiments.train import get_trainers, make_env
import argparse
...
## TODO here we only have two agents, we need to change to number of agents and landmarks
...
def load_scenario(scenario_name):
    ...
    return scenario
## TODO why do we have make_env here?
