...
import pickle
import random
import pmaddpg.experiments.analyze as analyze
import pmaddpg.experiments.communication_tracker as communication_tracker
import os
import pmaddpg.experiments.rewards as rewards
import maddpg.common.tf_util as U
from maddpg.trainer.maddpg import MADDPGAgentTrainer , RMADDPGAgentTrainer, _RMADDPGAgentTrainer
...
def parse_args():
    ...
    parser.add_argument("--good-policy", type=str, default="rrmaddpg", help="policy for good agents")
    parser.add_argument("--adv-policy", type=str, default="rrmaddpg", help="policy of adversaries")
