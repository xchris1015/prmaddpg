...
class InfoTracker:
    def __init__(self, agent_name, arglist):
        ...
        self.base_filename = "../experiments/tracker_information/{}_{}_".format(self.arglist.commit_num,
                                                                                self.agent_name)

        keys = ["ag_reward",  # every episode
                ## TODO we might need not team dist reward and diff
                ...
                "target_q_std",  # same
                ## TODO concentrate on communication part
                "communication",
                "position",
                ## TODO is this goal vector for each agent?
                "goal"
                ]  # every episode
        # episode information
    ...
    def record_information(self, key, value):
        if not self.start_tracking: return
        self.episode_information[key].append(value)
    ...
    def average(self, key):
        return np.mean(self.episode_information[key])